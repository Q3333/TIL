# R 수행평가 - 블로그 검색 API 워드클라우드



#R 스크래핑 Java연동 형태소 분석 결과 워드 클라우드로 시각화 

네이버 Open API 중 블러그 검색을 위한 API를 이용하여 
"백두산" 검색어로 
검색된 블로그 100개에 대해 첫 페이지부터 유사도순으로 정렬해 정보
(블러그 링크, 제목, 이름, 요약정보)를 받아 
형태소 분석을 수행하고, 워드 클라우드에 표현할 단어를 
빈도수 기준으로 상위 50개 단어 추출하여 워드 클라우드로 시각화 하시오
...
![1569563072170](assets/1569563072170.png)
