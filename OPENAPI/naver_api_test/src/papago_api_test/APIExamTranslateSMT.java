...
public class APIExamTranslateSMT {

    public static void main(String[] args) {
        String clientId = "swl1F1ABu_h3IfCLqXSv";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "vOrIY0xBog";//애플리케이션 클라이언트 시크릿값";
        try {
           // String text = URLEncoder.encode("안녕하세요. 오늘 기분은 어떻습니까?", "UTF-8");
        	
        	//String text = URLEncoder.encode("배고프다 집가고싶다 춥다 졸리다 게임하고싶다", "UTF-8");
