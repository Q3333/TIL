...
//function productModify(pcode) {
	//	f.action="modify.do?pcode="{product.pcode};
		//f.submit();	}
  ...
  <!--contents-->
	  ...
	  <table width=590 border=0 cellpadding=0 cellspacing=0>
		  <tr  height="40">
			...
			<input type="button" value="상품정보 수정" onClick= "location.href='./modify.do?pcode=${product.pcode}'" > &nbsp;
			
			<input type="button" value="상품정보 삭제" 
			onClick="productRemove()"> &nbsp; 
			
			
			<!--  <input type="button" value="상품정보 삭제" onClick= "location.href='./delete.do?pcode=${product.pcode}'" > &nbsp;--> 
